  ...
  return (
    ...
    >
      <Box typography="h4" display="flex" gap={4}>
        {props.title}
        <Button sx={{ marginLeft: "auto" }} onClick={() => props.onSave(guest)}>
          Save
        </Button>
        <Button
      ...
      <FormControl fullWidth>
        ...
        >
          {Object.keys(props.enums.gender.values).map((g) => (
            <MenuItem
              value={props.enums.gender.values[g]}
              key={props.enums.gender.values[g]}
            >
              {g}
            </MenuItem>
          ))}
      ...
      <FormControl fullWidth>
        ...
        >
          {Object.keys(props.enums.status.values).map((g) => (
            <MenuItem
              value={props.enums.status.values[g]}
              key={props.enums.status.values[g]}
            >
              {g}
            </MenuItem>
          ))}
